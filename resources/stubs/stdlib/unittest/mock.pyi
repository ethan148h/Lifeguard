...
class _SentinelObject:
    name: Any
    def __init__(self, name: Any) -> None: no_effects()
...
class Base:
    def __init__(self, *args: Any, **kwargs: Any) -> None: no_effects()
...
class NonCallableMock(Base, Any):
    if sys.version_info >= (3, 12):
        ...
        def __new__(cls, /, *args: Any, **kw: Any) -> Self: no_effects()
...
class _patch_dict:
    ...
    values: Any
    clear: Any
    def __init__(self, in_dict: Any, values: Any = (), clear: Any = False, **kwargs: Any) -> None: no_effects()
...
class MagicMixin(Base):
    def __init__(self, *args: Any, **kw: Any) -> None: no_effects()
...
class MagicProxy(Base):
    name: str
    parent: Any
    def __init__(self, name: str, parent: Any) -> None: no_effects()
...
if sys.version_info >= (3, 13):
    class ThreadingMixin(Base):
        ...
        def __init__(self, /, *args: Any, timeout: float | None | _SentinelObject = ..., **kwargs: Any) -> None: no_effects()
