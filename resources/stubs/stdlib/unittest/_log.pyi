...
class _AssertLogsContext(_BaseTestCaseContext, Generic[_L]):
    ...
    if sys.version_info >= (3, 10):
        def __init__(self, test_case: TestCase, logger_name: str, level: int, no_logs: bool) -> None: no_effects()
        no_logs: bool
    else:
        def __init__(self, test_case: TestCase, logger_name: str, level: int) -> None: no_effects()
