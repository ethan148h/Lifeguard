...
class _WritelnDecorator:
    def __init__(self, stream: _SupportsWriteAndFlush) -> None: no_effects()
    def writeln(self, arg: str | None = None) -> None: ...
...
class TextTestResult(unittest.result.TestResult, Generic[_StreamT]):
    ...
    if sys.version_info >= (3, 12):
        durations: int | None
        def __init__(self, stream: _StreamT, descriptions: bool, verbosity: int, *, durations: int | None = None) -> None: no_effects()
    else:
        def __init__(self, stream: _StreamT, descriptions: bool, verbosity: int) -> None: no_effects()
