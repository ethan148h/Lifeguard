...
def setprofile(func: ProfileFunction | None) -> None: unsafe()

if sys.version_info >= (3, 12):
    def setprofile_all_threads(func: ProfileFunction | None) -> None: unsafe()
    def settrace_all_threads(func: TraceFunction) -> None: unsafe()

if sys.version_info >= (3, 10):
    def gettrace() -> TraceFunction | None: no_effects()
    def getprofile() -> ProfileFunction | None: no_effects()
...
class Thread:
    ...
    def start(self) -> None: unsafe()
    def run(self) -> None: unsafe()
    def join(self, timeout: float | None = None) -> None: unsafe()
    @property
...
class _RLock:
    ...
    def release(self) -> None: unsafe()
    __enter__ = acquire
    def __exit__(self, t: type[BaseException] | None, v: BaseException | None, tb: TracebackType | None) -> None: unsafe()
...
class Condition:
    def __init__(self, lock: Lock | _RLock | RLock | None = None) -> None: no_effects()
    def __enter__(self) -> bool: unsafe()
    def __exit__(
    ...
    def wait(self, timeout: float | None = None) -> bool: unsafe()
    def wait_for(self, predicate: Callable[[], _T], timeout: float | None = None) -> _T: unsafe()
    def notify(self, n: int = 1) -> None: unsafe()
    def notify_all(self) -> None: unsafe()
    @deprecated("Deprecated since Python 3.10. Use `notify_all()` instead.")
    def notifyAll(self) -> None: unsafe()

class Semaphore:
    _value: int
    def __init__(self, value: int = 1) -> None: no_effects()
    def __exit__(self, t: type[BaseException] | None, v: BaseException | None, tb: TracebackType | None) -> None: unsafe()
    def acquire(self, blocking: bool = True, timeout: float | None = None) -> bool: unsafe()
    def __enter__(self, blocking: bool = True, timeout: float | None = None) -> bool: unsafe()
    def release(self, n: int = 1) -> None: unsafe()

class BoundedSemaphore(Semaphore): ...

class Event:
    def is_set(self) -> bool: no_effects()
    @deprecated("Deprecated since Python 3.10. Use `is_set()` instead.")
    def isSet(self) -> bool: no_effects()
    def set(self) -> None: unsafe()
    def clear(self) -> None: unsafe()
    def wait(self, timeout: float | None = None) -> bool: unsafe()
...
class Barrier:
    ...
    def broken(self) -> bool:
        ...
        ...
    def __init__(self, parties: int, action: Callable[[], None] | None = None, timeout: float | None = None) -> None: no_effects()
    def wait(self, timeout: float | None = None) -> int: unsafe()
    def reset(self) -> None: unsafe()
    def abort(self) -> None: unsafe()
