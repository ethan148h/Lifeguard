...
class MutableMapTypeFactory:
    def __init__(self, key_typeinfo, value_typeinfo) -> None: no_effects()
    def __call__(self, values=None) -> MutableMap[K, V]: ...

class MutableSetTypeFactory:
    def __init__(self, value_typeinfo) -> None: no_effects()
    def __call__(self, values=None) -> MutableSet[T]: ...

class MutableListTypeFactory:
    def __init__(self, value_typeinfo) -> None: no_effects()
    def __call__(self, values=None) -> MutableList[T]: ...
